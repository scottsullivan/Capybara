...
// make easier names for the float positions // maybe
...
int thresh = 40; // movement distance of tracked object threshold
int blobMinSize = 100;
int rightToLeft = 0;
int leftToRight = 0;
...
void draw() {
  ...
  fill(255);
  text("LEFT TO RIGHT: " + leftToRight, 20, 30);
  text("RIGHT TO LEFT: " + rightToLeft, 20, 45);
  text("LENGTH OF ARRAY LIST: " + objectList.size(), 20, 60);
}
